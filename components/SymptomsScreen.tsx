  ...
  return (
    <div className="mx-auto w-full max-w-md px-5 pb-6 pt-8">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-lg font-bold text-black">Symptoms</h1>
      </div>
                  ...
                  <button
                    ...
                    className={`rounded-full border px-3.5 py-2 text-sm font-medium transition ${
                      isSelected
                        ...
                        : "border-black bg-white/[0.03] text-black"
                    }`}
                  >
                    {symptom}
                  </button>
      ...
      <div className="mt-5 flex items-center gap-2">
        <input
          ...
          className="w-full rounded-xl border border-surface-border bg-white/[0.03] px-4 py-3 text-sm text-slate-200 placeholder:text-black focus:outline-none"
        />
        <button
          onClick={addCustomSymptom}
          className="flex items-center gap-1 rounded-xl border border-surface-border bg-green-950 px-4 py-3 text-sm font-semibold text-white hover:bg-white/[0.06]"
        >
          <Plus size={15} />
          Add
        </button>
      ...
      <button
        ...
        disabled={!hasSelection}
        className="mt-2 flex w-full items-center justify-center gap-1.5 py-2 text-sm font-semibold text-black hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-50"
      >
