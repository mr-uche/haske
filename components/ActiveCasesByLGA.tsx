...
const top12 = [...lgaData].sort((a, b) => b.activeCases - a.activeCases).slice(0, 12);

export default function ActiveCasesByLGA() {
  return (
    <div className="rounded-2xl border border-surface-border bg-green-950 p-5">
      <h3 className="text-sm font-semibold text-white">Active Cases by LGA</h3>
      <p className="text-xs text-slate-500">Top 12 LGAs ranked by active cases</p>
