    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
        <div className="rounded-2xl border border-brand-500/20 bg-brand-500 p-5">
          ...
          <p className="text-xs text-slate-400">Haske Hubs</p>
        </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">{f.lga}</p>
                  </div>
                </div>
                <span
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                ...
                <div className="rounded-xl bg-white/5 p-3">
                  ...
                  <p className={`mt-1 text-lg font-bold ${isOffline ? "text-slate-600" : "text-white"}`}>
                    {f.dailyVisits}
                  </p>
                </div>
              </div>
